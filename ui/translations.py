...
class Translations:
    ...
    TEXTS = {
        ...
        'chaos_sweep_group':      {'tr': 'Parametre Taraması',          'en': 'Parameter Sweep'},
        'chaos_sweep_param':      {'tr': 'Taranacak parametre:',        'en': 'Sweep parameter:'},
        'chaos_sweep_min':        {'tr': 'Min:',                        'en': 'Min:'},
        'chaos_sweep_max':        {'tr': 'Max:',                        'en': 'Max:'},
        'chaos_sweep_steps':      {'tr': 'Adım sayısı:',                'en': 'Steps:'},
        'chaos_calc_bifurcation': {'tr': 'Bifurcation Diyagramı Hesapla', 'en': 'Calculate Bifurcation Diagram'},
        'chaos_calc_lyap_sweep':  {'tr': 'Lyapunov Taraması Hesapla',   'en': 'Calculate Lyapunov Sweep'},
        'chaos_sweep_no_system':  {'tr': '(sistem bilinmiyor — sadece built-in sistemler)',
                                   'en': '(system unknown — only built-in systems supported)'},
